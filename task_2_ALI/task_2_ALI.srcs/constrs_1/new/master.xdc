...
## Switches
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {in[0]}];  # Switch 0
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {in[1]}];  # Switch 1
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {in[2]}];  # Switch 2
set_property -dict {PACKAGE_PIN W17 IOSTANDARD LVCMOS33} [get_ports {in[3]}];  # Switch 3
...
set_property -dict {PACKAGE_PIN T1  IOSTANDARD LVCMOS33} [get_ports {en}]; # Switch 14
set_property -dict {PACKAGE_PIN R2  IOSTANDARD LVCMOS33} [get_ports {wnr}]; # Switch 15
...
set_property -dict {PACKAGE_PIN P1  IOSTANDARD LVCMOS33} [get_ports {empty}]; # LED 14
set_property -dict {PACKAGE_PIN L1  IOSTANDARD LVCMOS33} [get_ports {full}]; # LED 15
